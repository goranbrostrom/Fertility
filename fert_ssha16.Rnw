...
and \citet{tbdr14}. One perhaps convincing theory is that the fertility decline was a
necessary result of the mortality decline. 
...
Umeå is older than Skellefteå as a town: The birth year of the town Umeå is generally recognized as 1622.
Umeå became early a center for administration and education, but Umeå University is not a fact before 1963. 
Early in the twentieth century, two military regiments were placed in Umeå, and they remained there during the first half of the century.
...
@
Woman No.\ 233 got married at age 24 (years), was followed until age 46.468 whed she died,
...
There are 225\,792 unique combinations of the levels of the expanatory
...
late 1970s, Jan M.\ Hoem taught us how to do this with software analysing
loglinear models for contigency tables, see \citet{hoem87,jmh11} and
...
for a different reason: We are analysing larger and larger data sets, and
...
spacing behavior is measured by their {\tt 'M'}. We show the delopment by
...
This model contains no less than 240 estimated coefficients: You do not want to see them in print, and I certainly do not want to show them. Instead, first I show the statistical significance of the threeway interactions in 
...
The question of whether it is spacing or stopping that dominates the behavioral explanation of the fertility decline over time is not definitivly settled, but the stopping measure, Coale-Trussell's "little {\tt m}" shows a more dramatic change over time than the corresponding spacing measure "big {\tt M}". This is especially true in the cohort setting.
