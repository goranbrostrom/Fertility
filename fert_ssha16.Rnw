...
take place. The study area is Skellefteå, a large rural region in the north of
Sweden.  
...
situated in the north of Sweden \citep{wee16}. All women, ever married and born between 1 January 1821 and 31 December 1935 and present in the region at age 15, are included in the
...
x <- head(fert1[, c("id", "marAge", "birthdate", "hisclass", "socBranch", "enter", "exit", "event")])
print(xtable(x, digits = c(0,0, 3,3,0,0, 3, 3, 0), caption = "First six records from the data file.", label = "tab:sixrow"), include.rownames = FALSE)
@
